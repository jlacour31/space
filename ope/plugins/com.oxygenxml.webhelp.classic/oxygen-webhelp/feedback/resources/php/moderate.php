...
if (isset($_POST['id']) && trim($_POST['id']) != '') {
    ...
    if (isset($_POST['uncodedId']) && trim($_POST['uncodedId']) != '' && is_numeric($_POST['uncodedId'])) {
        ...
        if (isset($_POST['ids']) && trim($_POST['ids']) != '' && is_numeric_list($_POST['ids'])) {
            $fullUser = base64_encode($_POST['product'] . "_" . $_POST['version'] . "_user");
