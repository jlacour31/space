...
set CLASSPATH=%DITA_DIR%lib\jackson-annotations-2.10.1.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.10.1.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.10.1.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-dataformat-yaml-2.10.1.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\snakeyaml-1.24.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%plugins\com.oxygenxml.common\lib\jaxb-core-2.3.0.1.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%plugins\com.oxygenxml.common\lib\jaxb-impl-2.3.0.1.jar;%CLASSPATH%
