...
set CLASSPATH=%DITA_DIR%lib\ant-apache-resolver-1.10.9.jar;%CLASSPATH%
...
set CLASSPATH=%DITA_DIR%lib\icu4j-69_1.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\isorelax-20030108.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-annotations-2.11.0.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-core-2.11.0.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-databind-2.11.0.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jackson-dataformat-yaml-2.11.0.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\jing-20181222.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\logback-classic-1.2.6.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\logback-core-1.2.6.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\slf4j-api-1.7.25.jar;%CLASSPATH%
set CLASSPATH=%DITA_DIR%lib\snakeyaml-1.26.jar;%CLASSPATH%
